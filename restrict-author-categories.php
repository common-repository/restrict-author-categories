...
/*
	...
	Description: Restrict on which categories a user can post. Just that! It also blocks the users to create/edit/delete categories. Works with block editor and classic editor.
	Version: 1.1
	Author: romulovs
